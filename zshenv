...
export FZF_DEFAULT_OPTS="--height 50% --reverse --border --inline-info --preview '(highlight --out-format=xterm256 --style=Candy {} 2> /dev/null || cat {} || tree -C {}) 2> /dev/null | head -200'"
